...
y_init = zipParams(eta0_init, phi0_init, delta_init, A_init, width_init, sigmastar_init, C_init, phi_fudge_init);


residualsfxn = @(y) getResiduals(dataTable,phi_list,volt_list,y);
