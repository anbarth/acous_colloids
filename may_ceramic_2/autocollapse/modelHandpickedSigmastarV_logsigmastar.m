function [x,F,delta_F,F_hat,eta,delta_eta,eta_hat] = modelHandpickedSigmastarV_logsigmastar(stressTable, y)
...
width = y(5);
logsigmastar0 = y(6);
logsigmastara = y(7:12);
sigmastar = [exp(logsigmastar0), exp(logsigmastar0) + exp(logsigmastara)];
D = y(13:end);
