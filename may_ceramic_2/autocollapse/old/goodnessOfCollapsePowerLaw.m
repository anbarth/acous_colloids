function goodness = goodnessOfCollapsePowerLaw(stressTable, phi_list, volt_list, paramsVector)

[eta0, phi0, delta, sigmastar, C, phi_fudge] = unzipParamsPowerLaw(paramsVector,length(phi_list));
