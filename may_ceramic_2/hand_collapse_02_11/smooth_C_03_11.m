...
for jj=1:size(C,2)
    ...
    plot(myPhi,logistic(cFit.L,cFit.k,cFit.x0,cFit.x1,myPhi,voltage),'Color',myColor,'LineWidth',1.5)
end
...
quad = polyfit(volt_list(1:5),sigmastar(1:5),2);
