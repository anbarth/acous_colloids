...
show_F_vs_x(acoustics_free_data,y,@modelLogisticCExp0V,'ColorBy',2,'ShowLines',true,'ShowErrorBars',true,'ShowInterpolatingFunction',true)
xlim([1e-5 1.5])
prettyPlot;

show_F_vs_xc_x(acoustics_free_data,y,@modelLogisticCExp0V,'ColorBy',2,'ShowLines',true,'ShowErrorBars',true,'ShowInterpolatingFunction',true)
prettyPlot;