...
sigmastar = sigmastar_list_full(my_phi_num-5,:);

y_handpicked_03_19 = [eta0, phi0, delta, A, width, sigmastar, D];

if whichPlot==1
    show_F_vs_x(dataTable,y_handpicked_03_19,@modelHandpickedSigmastarV,'PhiRange',my_phi_num,'ShowLines',true,'VoltRange',voltRange,'ColorBy',1,'ShowInterpolatingFunction',showFxn)
    xlim([1e-3 1.5])
elseif whichPlot == 2
    show_F_vs_xc_x(dataTable,y_handpicked_03_19,@modelHandpickedSigmastarV,'PhiRange',my_phi_num,'ShowLines',true,'VoltRange',voltRange,'ColorBy',1,'ShowInterpolatingFunction',showFxn)
end
