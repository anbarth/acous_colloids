...
residualsfxn = @(log_y) get_residuals(acoustics_free_data,logParamsToParams(log_y,3,6),myModelHandle);
costfxn = @(log_y)  sum(get_residuals(acoustics_free_data,logParamsToParams(log_y,3,6),myModelHandle).^2);
...
y_fminsearch_0V = logParamsToParams(log_y_fminsearch_0V,3,6);
...
y_lsq_0V = logParamsToParams(log_y_lsq_0V,3,6);
...
y_fmincon_0V = logParamsToParams(log_y_fmincon_0V,3,6);
