...
for ii=1:length(phi_list)
    ...
    myMarker = 'd';
    plot(ax_eta,sigma,eta, strcat(myMarker,'-'),'Color',myColor,'LineWidth',0.5);
    scat = scatter(ax_eta,sigma,eta,[],myColor,'filled','d','MarkerFaceAlpha',0.5);
    
    plot(ax_rate,sigma./eta,eta, '-d','Color',myColor,'LineWidth',0.5);
