...
fig_eta = figure;
ax_eta = axes('Parent', fig_eta,'XScale','log','YScale','log','ZScale','log');
ax_eta.XLabel.String = '\eta(\phi_0-\phi)^2 (Pa s)';
ax_eta.YLabel.String = '\Delta\eta(\phi_0-\phi)^2 (Pa s)';
ax_eta.ZLabel.String = 'P';
hold(ax_eta,'on');
cmap = plasma(256);
...
for ii=phi_range
    ...
    scatter3(ax_eta,eta_rescaled,delta_eta_rescaled,P,[],myColor,'filled',marker);
end
colorbar;