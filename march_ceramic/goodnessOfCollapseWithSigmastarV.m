function goodness = goodnessOfCollapseWithSigmastarV(stressTable,phiRange,mySigmaStar,print)

if nargin < 3
    print = 0;
end

vol_frac_plotting_range = phiRange;
volt_plotting_range = 1:8;

collapse_params;

% redefine f in terms of the input sigmastar
