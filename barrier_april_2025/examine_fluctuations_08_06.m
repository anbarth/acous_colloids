...
title('\sigma=0.01 Pa(rheo)'); xlabel('t (s)'); ylabel('rate (1/s)')
...
figure; hold on; prettyplot;
title('\sigma=0.1 Pa(rheo)'); xlabel('t (s)'); ylabel('rate (1/s)')
ax1=gca; ax1.YScale='log';
...
figure; hold on; prettyplot;
title('\sigma=1 Pa(rheo)'); xlabel('t (s)'); ylabel('rate (1/s)')
ax1=gca; ax1.YScale='log';
...
figure; hold on; prettyplot;
title('\sigma=10 Pa(rheo)'); xlabel('t (s)'); ylabel('rate (1/s)')
ax1=gca; ax1.YScale='log';
