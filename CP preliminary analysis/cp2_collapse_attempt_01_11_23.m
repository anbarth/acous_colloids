...
C1 = [1.4000    1.1900    0.9800    0.5320];
C2 = [1.4400    1.2000    0.9600    0.5400];
C3 = [1.5400    1.2600    1.0500    0.5600];
C4 = [1.3650    1.0790    0.9230    0.5200];
C5 = [1.3000    1.1400    0.9450    0.5200];
C6 = [1.2000    1.0200    0.8400    0.5040];
C7 = [1.1400    0.9120    0.7600    0.4800];
C8 = [1.0800    0.8640    0.7200    0.4800];
